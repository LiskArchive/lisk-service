...
| [Newsfeed](services/newsfeed) | The news feed service is a one-purpose microservice that polls the content sharing platforms and shares collected data with UI clients such as Lisk Desktop |
| [Transaction](services/transaction) | The Transaction service is a proxy between all participants before the multisignature transaction is ready to broadcast |
