...
It is possible to enable or create a snapshot of the MySQL database, and the available xref:{snapshot_config}[MySQL snapshot configurations] can be found in the Lisk Service configuration reference page.
