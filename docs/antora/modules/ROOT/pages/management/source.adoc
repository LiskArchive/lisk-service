...
TIP: The process ID of each PM2-managed process can be seen by executing the <<list>> command. To learn more about PM2 log management please refer the xref:{url_pm2_management}[PM2 logs documentation].
