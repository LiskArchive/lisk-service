	...
	apps: [
		{
			...
			env: {
				...
				RATE_LIMIT_ENABLE_WS: false,
				RATE_LIMIT_CONNECTIONS_WS: 5,
				RATE_LIMIT_DURATION_WS: 1, // in seconds
				RATE_LIMIT_ENABLE_HTTP: false,
				RATE_LIMIT_CONNECTIONS_HTTP: 200,
				RATE_LIMIT_WINDOW_HTTP: 10, // in seconds
