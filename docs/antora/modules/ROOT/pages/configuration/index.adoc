...
| boolean
| Boolean flag to enable downloading the snapshot from an (unsecured) HTTP URL. By default, the value is false.
| false
...
The MySQL/MariaDB snapshot related properties are part of the Lisk indexer service, and the relevant configurations can be seen in the table below.
