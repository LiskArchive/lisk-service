...
When running a local instance of Lisk Core and Lisk Service that is run by Docker, then the following path needs to be set: `LISK_CORE_WS="ws://host.docker.internal:4000"`.
