...
On this page you'll find the most relevant PM2 commands for running source based Lisk Service installation.
For more details about PM2, see {url_pm2_docs}[PM2 docs].

We'll also talk about steps to reset a Lisk Service node.
