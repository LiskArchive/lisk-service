...
const TRANSACTION_EXECUTION_STATUS = /^(pending|success|fail)(,(pending|success|fail)){0,2}$/;
const POS_VALIDATOR_STATUS = /^\b(active|standby|banned|punished|ineligible)(,(active|standby|banned|punished|ineligible)){0,4}$/;
const HASH_SHA256 = /^\b([A-Fa-f0-9]){64}\b$/;
const HASH_SHA512 = /^\b([A-Fa-f0-9]){128}\b$/;
const CCM_STATUS = /^(ok|module_not_supported|module_not_supported|channel_unavailable|recovered)(,(ok|module_not_supported|module_not_supported|channel_unavailable|recovered)){0,4}$/;
const INTERVAL = /^\b((\d{4})-((1[012])|(0?[1-9]))-(([012][1-9])|([123]0)|31))(:((\d{4})-((1[012])|(0?[1-9]))-(([012][1-9])|([123]0)|31)))?\b$/g;
const NETWORK_CSV = /^(mainnet|testnet|betanet|alphanet|devnet)(,(mainnet|testnet|betanet|alphanet|devnet)){0,4}$/;
const APPLICATION_STATUS = /^(registered|active|terminated|unregistered)(,(registered|active|terminated|unregistered)){0,3}$/;
const MODULE_COMMAND = /^[a-zA-Z][\w]{0,31}:[a-zA-Z][\w]{0,31}$/;
const CHAIN_ID = /^\b[a-fA-F0-9]{8}\b$/;
const CHAIN_ID_CSV = /^\b([a-fA-F0-9]{8})(,[a-fA-F0-9]{8})*\b$/;
const TOKEN_ID = /^\b[a-fA-F0-9]{16}\b$/;
const TOKEN_ID_CSV = /^\b([a-fA-F0-9]{16})(,[a-fA-F0-9]{16})*\b$/;
