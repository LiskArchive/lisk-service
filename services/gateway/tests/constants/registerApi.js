...
const expectedResponseForRegisterHttpApi = [
	{
		whitelist: [
			...
			'indexer.nft.constants',
			'indexer.nft.history',
			'indexer.nft',
			'indexer.nft.escrowed',
			'indexer.nft.supported',
		...
		aliases: {
			...
			'GET nft': 'indexer.nft',
			'GET nft/constants': 'indexer.nft.constants',
			'GET nft/escrowed': 'indexer.nft.escrowed',
			'GET nft/history': 'indexer.nft.history',
			'GET nft/supported': 'indexer.nft.supported',
