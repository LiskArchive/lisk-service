...
To accelerate the indexing process, the blockchain-indexer microservice also supports automatic download and application of snapshot to the MySQL/MariaDB databases. The following environment variables can be used to configure the same.
