...
module.exports = {
	apps: [
		...
		{
			name: 'lisk-service-transaction',
			script: 'app.js',
			cwd: './services/transaction',
			pid_file: './pids/service_transaction.pid',
			out_file: './logs/service_transaction.log',
			error_file: './logs/service_transaction.err',
			log_date_format: 'YYYY-MM-DD HH:mm:ss SSS',
			watch: false,
			kill_timeout: 10000,
			max_memory_restart: '512M',
			...
			env: {
				SERVICE_BROKER: 'redis://localhost:6379/0',
				SERVICE_TRANSACTION_MYSQL: 'mysql://lisk:password@localhost:3306/lisk?charset=utf8mb4',
			},
		},
	],
};
