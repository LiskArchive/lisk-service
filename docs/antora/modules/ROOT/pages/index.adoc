...
With regard to the WebSocket JSON-RPC API, as briefly described above in Table 2, the xref:{url_api_rpc}[RPC-API] reference provides an overview of all available RPC requests.
