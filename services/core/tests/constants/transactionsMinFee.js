...
module.exports = {
	...
	minFees: {
		...
		transactionType_4_0: BigInt('314000'),
		transactionType_5_0: BigInt('1000122000'),
		transactionType_5_1: BigInt('143000'),
		transactionType_5_2: BigInt('184000'),
		transactionType_5_3: BigInt('551000'),
		transactionType_1000_0: BigInt('118000'),
		multisig_transactionType_2_0: BigInt('217000'),
		multisig_transactionType_4_0: BigInt('314000'),
		multisig_transactionType_5_0: BigInt('1000186000'),
		multisig_transactionType_5_1: BigInt('209000'),
		multisig_transactionType_5_2: BigInt('539000'),
	},
};
