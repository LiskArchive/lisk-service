...
:url_websocket: https://github.com/LiskHQ/lisk-service/blob/v0.7.0-beta.0/docs/api/version3.md
:url_subapi: https://github.com/LiskHQ/lisk-service/blob/v0.7.0-beta.0/docs/api/websocket_subscribe_api.md
...
Although the above commands retrieve the entire source code, however, this does not cover building a custom version of Lisk Service.
...
.Example request: Obtain a list of all 103 currently forging delegates
[source,bash]
----
