...
1. Stop the existing running version of Lisk Service with the command listed below.
...
2. Checkout the specific version with *`git checkout <tag>`*.
----
git checkout v0.7.0
----
...
3. Restart Lisk Service with the following command.
...
NOTE: Please check the :url_rel...release notes for the relevant version to see if the existing databases need to be flushed.
