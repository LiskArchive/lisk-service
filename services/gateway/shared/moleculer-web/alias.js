...
param;
    ...
    multipartHandler(req, res) {
        ...
        busboy.on('file', (fieldname, file, filename, encoding, mimetype) => {
            ...
            numOfFiles++;
            promises.push(ctx.call(this.action, file, _.defaultsDeep({}, this.route.opts.callOptions, {
                meta: {
                    fieldname,
                    filename,
                    encoding,
        ...
        busboy.on('finish', async () => {
            /* istanbul ignore next */
            if (!busboyOptions.empty && numOfFiles == 0) return this.service.sendError(req, res, new MoleculerClientError('File missing in the request'));
            ...
            try {
                ...
                if (this.route.onAfterCall) data = await this.route.onAfterCall.call(this, ctx, this.route, req, res, data);
