= Update PM2 commands
Mona Bärenfänger <mona@lightcurve.io> Muhammad Talha <muhammad.talha@lightcurve.io> chris braithwaite <christopher.braithwaite@lightcurve.io>
:description: Describes how to manage Lisk Service v0.7.0 with PM2.
:toc:
:idseparator: -
:idprefix:
