...
1.Update `docker-compose.yml` to download the specific image versions from the DockerHub as shown below. Update the `0.7.0` tag against the specified images with the desired version.
...
3.Start Lisk Service in the containers.
...
2.Build the required updated Docker images.
----
make build
----
